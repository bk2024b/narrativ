    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="font-['Outfit']">
          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-16 w-24 h-1 bg-amber-500"
              ></motion.div>
              
              <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight font-['Cormorant_Garamond']">
                <span className="block text-amber-400 mb-2 text-xl uppercase tracking-[0.3em] font-light">Votre histoire</span>
                Transformez votre parcours en<br />
                <span className="text-amber-500">attraction magnétique</span>
              </h1>
              ...
              >
                <Link href="#signup">
                  <span className="inline-block bg-gradient-to-br from-amber-500 to-amber-700 text-white font-medium px-10 py-5 rounded-lg shadow-xl hover:shadow-amber-900/30 transition-all duration-300 uppercase tracking-wider border border-amber-400/30">
                    Accès prioritaire
                  </span>
                </Link>
              </motion.div>
              ...
              <div className="relative pt-6 border-t border-gray-700 max-w-2xl mx-auto">
                <div className="mt-6 flex flex-wrap justify-center gap-6">
                  <div className="flex items-center px-5 py-2 border border-gray-700 rounded-full bg-black bg-opacity-50">
        ...
        <section ref={whyRef} className="py-24 px-6 bg-gray-50 relative overflow-hidden" id="pourquoi">
          ...
          <div className="absolute top-0 right-0 w-80 h-80 bg-amber-100 rounded-full filter blur-3xl opacity-30 -translate-y-1/2 translate-x-1/3"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-amber-200 rounded-full filter blur-3xl opacity-20 translate-y-1/3 -translate-x-1/4"></div>
          ...
          <div className="container mx-auto">
            ...
            >
              <span className="uppercase text-amber-600 tracking-[0.2em] font-medium text-sm mb-3 inline-block">Votre histoire est précieuse</span>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-['Cormorant_Garamond']">
                Pourquoi partager <span className="text-amber-700">votre histoire</span> ?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white p-8 rounded-xl border border-gray-100 hover:border-amber-100 shadow-xl hover:shadow-2xl transition-all duration-500 group"
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-amber-50 mb-6 group-hover:bg-amber-100 transition-colors duration-300">
                    {item.icon}
                  </div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-['Cormorant_Garamond']">{item.title}</h3>
        ...
        <section ref={howRef} className="py-24 px-6 bg-white relative overflow-hidden" id="comment">
          <div className="absolute top-40 right-0 w-96 h-96 bg-amber-50 rounded-full filter blur-3xl opacity-70"></div>
          ...
          <div className="container mx-auto">
            ...
            >
              <span className="uppercase text-amber-600 tracking-[0.2em] font-medium text-sm mb-3 inline-block">Notre processus</span>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-['Cormorant_Garamond']">
                Comment <span className="text-amber-700">ça marche</span> ?
              </h2>
              <div className="w-24 h-1 bg-amber-500 mx-auto mb-8"></div>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="relative max-w-5xl mx-auto">
              {/* Ligne de connexion */}
              <div className="hidden md:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-amber-300 via-amber-500 to-amber-700 z-0"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {[
                  ...
                  >
                    <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-xl hover:shadow-2xl hover:border-amber-100 transition-all duration-300 h-full">
                      <div className="flex justify-center mb-6">
                        <div className="flex items-center justify-center w-14 h-14 rounded-full bg-amber-50 border-2 border-amber-500 text-amber-700 font-bold text-xl">
                          {item.step}
                        </div>
                      </div>
                      <h3 className="text-2xl font-semibold text-gray-900 mb-4 text-center font-['Cormorant_Garamond']">{item.title}</h3>
        ...
        <section ref={ctaRef} id="signup" className="py-24 px-6 bg-gray-900 text-white relative overflow-hidden">
          ...
          <div className="absolute top-40 right-0 w-96 h-96 bg-amber-500 rounded-full filter blur-3xl opacity-10"></div>
          <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-amber-700 rounded-full filter blur-3xl opacity-10"></div>
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <span className="uppercase text-amber-400 tracking-[0.2em] font-medium text-sm mb-3 inline-block">Lancement imminent</span>
                <h2 className="text-4xl md:text-5xl font-bold mb-6 font-['Cormorant_Garamond']">
                  Rejoignez les pionniers de <span className="text-amber-500">Narrativ</span>
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300"
                      required
                    />
                  </div>
                  <div>
                  ...
                  <div className="pt-3">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-amber-500 to-amber-700 text-white font-medium py-4 px-6 rounded-lg hover:from-amber-600 hover:to-amber-800 transition-all duration-300 shadow-lg flex items-center justify-center uppercase tracking-wider"
                    >
                      {isSubmitting ? (
                        <>
